        <div id='profile' className="w-full py-20 bg-neutral-950 text-white snap-start h-screen no-scrollbar">
                ...
                <div className="container mx-auto px-8 items-center justify-between gap-1">
                    ...
                    <div className="flex flex-col items-start text-left max-w-screen-lg space-h-2 mt-10">
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            <motion.a 
                                href="https://drive.google.com/uc?export=download&id=1-NYMNzJHkwpKV9EI_MbcAk2SGR5J9jlF" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} initial = {{scale: 0}} animate={{scale:1}} 
...
const Main = () => {
    ...
    //     {
    //         Title: 'Education',
    //         decription_list: ['BSc Honours Computer Science: 1st Class', 'A Level: Computer Science - A*, Politics - A, Philosophy - A']
    //     },

    //     {
    //         Title: 'Experience',
    //         decription_list: ['Software Development', 'Product Management', 'Data Analytics', 'Financial/Technology Risk']
    //     },

    //     {
    //         Title: 'Skills',
    //         decription_list: ['Java, Python, React, SQL, APIs, HTML, CSS, JavaScript, PySpark']
    //     },
    ...
    //     className='border-2 rounded w-11/12 sm:w-80 md:w-96 h-72 mx-auto flex flex-col justify-center items-center text-center p-4'
    // >
  ...
  return (
    <div className='homepage_section1'>
        <div className='homepage_section1_layout'>
            <TypeAnimation className={`text-white mb-2 text-3xl font-medium`}
                sequence={['Software Developer', 1000,
                'Analyst', 1000, 
                'Product/Project Manager', 1000,
                'Finance/Technology Risk Consultant', 1000
                ...
                className={`text-white mb-6`}>Dare Mensah</motion.h1>
        ...
        {/* <section id="about" className="snap-start min-h-screen py-20 no-scrollbar mb-32 mt-20">
            <div className='snap-y snap-mandatory overflow-y-scroll h-screen scroll-smooth no-scrollbar'>
        ...
        <section id="work_experience" className="snap-start min-h-screen py-20 no-scrollbar mb-12 mt-20">
            <div className='snap-y snap-mandatory overflow-y-scroll h-screen scroll-smooth no-scrollbar py-40'>
                ...
                <VerticalTimeline>
                    ...
                    >
                    <h3 className="vertical-timeline-element-title text-2xl text-white ">S&OP Analyst</h3>
        ...
        <section id="projects" className="snap-start min-h-screen py-20 no-scrollbar mb-12 mt-20 ">
            <div className='snap-y snap-mandatory overflow-y-scroll h-screen scroll-smooth no-scrollbar'>
                ...
                <Swiper spaceBetween={50} slidesPerView={1}>
                    {Projects.map((project, index) => (
                        <SwiperSlide key={index}>
                            <img className='rounded-xl mb-4 mx-auto' height={600} width={600} src={project.image}/>
                            <div className='p-3 bg-neutral-900 rounded-xl'> 
                                <h1 className='font-semibold text-4xl mb-7'>{project.Title}</h1>
                                <p className='font-extralight'>{project.description}</p>
                                {project.decription_list.map((text_list, index) => (
                                <div key ={index}>
                                    <ol className='list-disc pl-5'>
                                        <li className='mt-4 font-extralight'>{text_list}</li>
                                    </ol>
                                </div>
                                ))}
                                <motion.a 
                                href={project.github_link} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                                <img src={githubimg} alt="GitHub" className="h-10 w-10 mt-9" />
                            </motion.a>
                            </div>
                        </SwiperSlide>
                    ))}
...
export default Main
                ...
                */}
                 ...
                 */}
                        ...
                        {/* Animated Cards 
                    <div className={`flex ${isMobile ? 'flex-cols-3 gap-1' : 'flex-wrap flex-cols-2 gap-16'} justify-center items-center mb-12`}>
                        <motion.button
                            onClick={() => setShowEducation(!showEducation)}
                            whileTap={{ scale: 0.95 }} whileHover={{ scale: 1.1 }} 
                            className="bg-neutral-950 px-4 py-2 rounded-lg text-white font-medium"
                        >
                            {(showEducation) ? (<img className={`${isMobile ? 'ml-5' : 'ml-0'}`} src={education} alt="Education" width={isMobile ? 85 : 150} /> ) : (<img src={education} alt="Education" width={isMobile ? 85 : 150} />)}
